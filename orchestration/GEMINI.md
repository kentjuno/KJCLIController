...
> Copy this file into the root of whatever project you orchestrate from. `GEMINI.md` is the
> context file Gemini/Antigravity reads, so it makes Gemini aware of the multi-agent setup.
