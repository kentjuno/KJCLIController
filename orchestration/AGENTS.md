...
> Copy this file into the root of whatever project you orchestrate from. `AGENTS.md` is the
> convention OpenAI Codex reads, so it makes Codex aware of the multi-agent setup.
